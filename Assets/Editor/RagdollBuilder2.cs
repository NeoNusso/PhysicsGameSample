...
{
    class RagdollBuilder2 : ScriptableWizard
    {
        ...
        [MenuItem("GameObject/3D Object/Ragdoll2...")]
        static void CreateWizard()
        {
            ScriptableWizard.DisplayWizard<RagdollBuilder2>("Create Ragdoll2");
        }
        ...
        void BuildJoints()
        {
            foreach (BoneInfo bone in bones)
            {
                ...
                var joint = Undo.AddComponent<ConfigurableJoint>(bone.anchor.gameObject);
                bone.joint = joint;
